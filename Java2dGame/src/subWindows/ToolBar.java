...
public class ToolBar {
	...
	public BufferedImage toolBar, activeToolBar, woodenHoe, watering_can;
...
public void draw(Graphics2D g2) {
		...
		case 3:
			...
			break;
		case 4:
			currentItemX=(gp.TILESIZE*5)+3*(16*4)+4*4;
			currentItemY=(gp.TILESIZE*12)+4;
			break;
		case 5:
			currentItemX=(gp.TILESIZE*5)+4*(16*4)+4*5;
			currentItemY=(gp.TILESIZE*12)+4;
			break;
		case 6:
			currentItemX=(gp.TILESIZE*5)+5*(16*4)+4*6;
			currentItemY=(gp.TILESIZE*12)+4;
			break;
		case 7:
			currentItemX=(gp.TILESIZE*5)+6*(16*4)+4*7;
			currentItemY=(gp.TILESIZE*12)+4;
			break;
		case 8:
			currentItemX=(gp.TILESIZE*5)+7*(16*4)+4*8;
			currentItemY=(gp.TILESIZE*12)+4;
			break;
		case 9:
			currentItemX=(gp.TILESIZE*5)+8*(16*4)+4*9;
			currentItemY=(gp.TILESIZE*12)+4;
			break;
		case 0:
			currentItemX=(gp.TILESIZE*5)+9*(16*4)+4*10;
			currentItemY=(gp.TILESIZE*12)+4;
			break;
		...
		//toolbar 1
		g2.drawImage(woodenHoe, (gp.TILESIZE*5)+4, (gp.TILESIZE*12)+4, 16*4, 16*4, null);
		
		//toolbar 2
		g2.drawImage(watering_can, (gp.TILESIZE*5)+(16*4)+4*2, (gp.TILESIZE*12)+4, 16*4, 16*4, null);
		
//		//toolbar 3
//		g2.drawImage(woodenHoe, (gp.TILESIZE*5)+2*(16*4)+4*3, (gp.TILESIZE*12)+4, 16*4, 16*4, null);
//		
//		//toolbar 4
//		g2.drawImage(woodenHoe, (gp.TILESIZE*5)+3*(16*4)+4*4, (gp.TILESIZE*12)+4, 16*4, 16*4, null);
//		
//		//toolbar 5
...
//		
//		//toolbar 10
//		g2.drawImage(woodenHoe, (gp.TILESIZE*5)+9*(16*4)+4*10, (gp.TILESIZE*12)+4, 16*4, 16*4, null);
	}
}
