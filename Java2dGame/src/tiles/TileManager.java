...
public class TileManager {
	...
	public void getTileImage() {
		...
		tile[2472].collision = true;
		tile[2473].collision = true;
		tile[2474].collision = true;
		tile[2475].collision = true;//
		...
		tile[899].collision = true;
		tile[949].collision = true;
		tile[999].collision = true;
		tile[1049].collision = true;
		tile[1099].collision = true;
		tile[1149].collision = true;
		tile[1199].collision = true;
		tile[1249].collision = true;
		tile[1299].collision = true;
		tile[1349].collision = true;
		tile[1399].collision = true;
		tile[1449].collision = true;
		tile[1499].collision = true;
		tile[1549].collision = true;
		tile[1599].collision = true;
		tile[1649].collision = true;
		tile[1699].collision = true;
		tile[1749].collision = true;
		tile[1799].collision = true;
		tile[1849].collision = true;
		tile[1899].collision = true;
		tile[1949].collision = true;
		tile[1999].collision = true;
		tile[2049].collision = true;
		tile[2099].collision = true;
		tile[2149].collision = true;
		tile[2199].collision = true;
		tile[2249].collision = true;
		tile[2299].collision = true;
		tile[2349].collision = true;
	}
	...
	public void setup(int index, boolean collision) {
		...
		try {
			tile[index] = new Tile();
			tile[index].image = ImageIO.read(getClass().getResource("/world/MapPetaniMuda_" + index + ".png"));
